...
struct CodingValidationExecutionStage: Sendable {
    let id: String
    let name: String
    let commands: [String]
    let haltOnFailure: Bool
...
struct CodingValidationExecutionPlan: Sendable {
...
public actor CodingValidationCoordinator {
    ...
    func resolvePlan(for repoURL: URL) -> CodingValidationExecutionPlan {
    ...
    private func runShell(
        ...
        let stdoutBuffer = ThreadSafeData()
        let stderrBuffer = ThreadSafeData()
